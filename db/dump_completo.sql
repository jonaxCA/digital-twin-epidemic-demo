...
--
-- Archivo generado automaticamente concatenando, en orden, las 12 migraciones
-- numeradas del proyecto:
--   001_base.sql            005_vigilancia.sql        009_roles_bd.sql
--   002_seguridad.sql       006_escenarios.sql        010_datos_iniciales.sql
--   003_sistema.sql         007_simulacion.sql        011_fix_audit_log_delete.sql
--   004_catalogos.sql       008_comentarios.sql       012_corrige_claves_inegi_nl.sql
--
...
-- correr los 12 .sql uno por uno, pero en una sola pasada.
--
